def main(training_parameters_name, num_gpus, num_nodes):
    ...
    modelTest = B_CNN_Lightning.load_from_checkpoint(ckpt_path)
    modelTest.eval()
...
if __name__ == "__main__":
    ...
    from libraries.lightningDMBCNN_basic import ImageFolderLightningDataModule
    from libraries.lightningModelBCNN_basic import B_CNN_Lightning
