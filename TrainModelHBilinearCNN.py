def main(training_parameters_name, num_gpus, num_nodes):
    ...
    #modelTest = HB_CNN_Lightning.load_from_checkpoint(BEST_MODEL_CHECKPOINT)
    modelTest = HB_CNN_Lightning.load_from_checkpoint(ckpt_path)
    modelTest.eval()
...
if __name__ == "__main__":
    ...
    from libraries.lightningDMHBilinearCNN import ImageFolderLightningDataModule
    from libraries.lightningModelHBilinearCNN import HB_CNN_Lightning
