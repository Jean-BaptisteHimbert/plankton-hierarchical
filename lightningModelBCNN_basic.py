...
class BranchLeaf(nn.Module, ABC):
    ...
    def forward(self, x_main):        
        return self.layer3(x_main)

class BodyBCNN(nn.Module, ABC):
...
class B_CNN(nn.Module, ABC):
    def __init__(self,
        ...
        self.branch_body = BodyBCNN(feature_extractor_path=feature_extractor_path,
...
class B_CNN_Lightning(LightningModule, ABC):
    def __init__(   self,
                    results: Path,
                    model_name: str,
        ...
        print(f"feature extractor path is: {feature_extractor_path}")
        # create model
        self.model = B_CNN(feature_extractor_path=feature_extractor_path,
